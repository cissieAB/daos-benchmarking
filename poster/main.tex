...
\begin{column}{\colwidth}
  ...
  \begin{block}{IO500}
    ...
    \end{minipage}
    \par\medskip
    {{\normalsize{\textbf{DFS achieved \~5x higher bandwidths and \~190x higher IOPS than POSIX on a DFuse mount, making major improvements to metadata and reading operations}}}}
