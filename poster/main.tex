...
\begin{column}{\colwidth}
  ...
  \begin{block}{DAOS Storage System}
    ...
    \begin{figure}
      ...
      \caption{DAOS pool data heirarchy \cite{daos_guide}}
      \label{fig:DAOS_Pool_Cont_Obj}
    \end{figure} 
    
    DAOS accessed via the native DAOS library libdaos, mounting a container via DAOS FUSE, and the interception library libpil4dfs. 
  ...
  \begin{block}{Aurora} 
    ...
    % \end{figure}
    \begin{itemize}
      \item Argonne National Lab's Aurora supercomputer has 230 PB of DAOS storage with 1024 DAOS server nodes.
