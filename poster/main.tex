...
\begin{column}{\colwidth}
  ...
  \begin{block}{DAOS Storage System}
    ...
    \begin{figure}
      \centering
        \includegraphics[width=\dimexpr 3\colwidth/4\relax]{diagrams/data_heirarchy.pdf}
  ...
  \begin{block}{Aurora} 
    ...
    \begin{itemize}
      ...
      \item Aurora compute nodes have 8 HPE Slingshot-11 NICs, using dragonfly topology and use two Intel Xeon CPU Max Series, with 52 cores each. For ior we bind to 48 cores per node.
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Benchmarking}
    ...
    variety of access patterns and client configurations on a pdocutions scale system.
  ...
  \begin{block}{fio Bandwidth}
    ...
    \normalsize{
    \begin{itemize}
      \item \textbf{fio bandwidth increased with I/O unit size, saturating at I/O size of 1-2 MiB}
  ...
  \begin{block}{IO500}
    ...
    \begin{minipage}[t]{0.48\colwidth}
      ...
      \begin{tabular}{|c|r|r|}
        ...
        \hline \hline
        ior-easy-write & 92.212784 GiB/s & 81.309150 GiB/s \\
        ior-easy-read & 212.561309 GiB/s & 10.761970 GiB/s \\
        ior-hard-write & 3.796917 GiB/s & 0.665114 GiB/s \\
        ior-hard-read & 15.250130 GiB/s & 3.159159 GiB/s \\
        \hline
        Bandwidth Score & 32.639612 GiB/s & 6.548241 GiB/s \\
        \hline
      \end{tabular}
    ...
    \begin{minipage}[t]{0.48\colwidth}
      ...
      \begin{tabular}{|c|r|r|}
        ...
        Test & \multicolumn{1}{c|}{DFS API} & \multicolumn{1}{c|}{POSIX API} \\
        \hline \hline
        find & 775.564385 kIOPS & 1.547148 kIOPS \\
        mdtest-easy-write & 219.381407 kIOPS & 3.927349 kIOPS \\
        mdtest-hard-write & 60.646540 kIOPS & 1.094255 kIOPS \\
        mdtest-hard-read & 807.330148 kIOPS & 3.857754 kIOPS \\
        mdtest-easy-stat & 1112.188044 kIOPS & 4.030321 kIOPS \\
        mdtest-hard-stat & 1098.314003 kIOPS & 3.849002 kIOPS \\
        mdtest-easy-delete & 301.045835 kIOPS & 3.389223 kIOPS \\
        mdtest-hard-delete & 302.557388 kIOPS & 0.386403 kIOPS \\
        \hline
        IOPS Score & 417.712528 kiops  & 2.185819 kiops \\
        \hline
      \end{tabular}
    ...
    \end{minipage}
    \par\medskip
    {{\normalsize{\textbf{DFS achieved higher bandwidths and IOPS than POSIX on a DFuse mount, especially regarding metadata and reading operations}}}}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{IOR Bandwidth}
    ...
    \begin{itemize}
      ...
      \item \textbf{When a sufficiently large transfer size and number of tasks is used, read bandwith falls}
    \end{itemize}
    }
