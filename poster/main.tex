...
\author{Rebecca George \inst{1} \and Cissie Mei \inst{2} \and Jie Ren \inst{1}}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{DAOS Storage System}
    ...
    Distributed Asynchronous Object Storage (DAOS) is a high performance storage system allowing:

    \begin{itemize}
      \item Asynchronous writes 
    \end{itemize}
