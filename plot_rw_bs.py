...
ax.set_title("Mean Read Bandwidth vs Block Size (# Jobs = 16)")
...
ax.set_title("Mean Write Bandwidth vs Block Size (# Jobs = 16)")
ax.legend(bbox_to_anchor=(1, 1), title='Read-Write Type')
...
ax.set_title("Write IOPS vs Block Size (# Jobs = 16)")
ax.legend(bbox_to_anchor=(1, 1), title='Read-Write Type')
...
ax.set_title("Read IOPS vs Block Size (# Jobs = 16)")
ax.legend(bbox_to_anchor=(1, 1), title='Read-Write Type')
...
ax.set_title("Mean Write Latency vs Block Size (# Jobs = 16)")
ax.legend(bbox_to_anchor=(1, 1), title='Read-Write Type')
...
ax.set_title("Mean Read Latency vs Block Size (# Jobs = 16)")
ax.legend(bbox_to_anchor=(1, 1), title='Read-Write Type')
